...
/datum/scream_type/arachnid
	...
	scream_sounds = list('modular_zmixite/modules/arachnids/sounds/arachnid_scream.ogg')

/datum/laugh_type/arachnid
	name = "Arachnid Laugh"
	laugh_sounds = list('modular_zmixite/modules/arachnids/sounds/arachnid_laugh.ogg')
