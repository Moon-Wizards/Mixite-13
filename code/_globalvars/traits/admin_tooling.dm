...
GLOBAL_LIST_INIT(admin_visible_traits, list(
	...
	/obj/item/toy/plush/nova = list(
		...
		//"TRAIT_APHRO" = TRAIT_APHRO, // M13 REMOVAL
		"TRAIT_AVIAN" = TRAIT_AVIAN,
		"TRAIT_ASH_ASPECT" = TRAIT_ASH_ASPECT,
		//"TRAIT_BIMBO" = TRAIT_BIMBO, // M13 REMOVAL
		...
		//"TRAIT_LEWDCHEM" = TRAIT_LEWDCHEM, // M13 REMOVAL
		//"TRAIT_LEWDQUIRK" = TRAIT_LEWDQUIRK, // M13 REMOVAL
		//"TRAIT_MASOCHISM" = TRAIT_MASOCHISM, // M13 REMOVAL
		...
		//"TRAIT_NEVERBONER" = TRAIT_NEVERBONER, // M13 REMOVAL
		...
		//"TRAIT_STRAPON" = TRAIT_STRAPON, // M13 REMOVAL
